...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('one/css/open-iconic-bootstrap.min.css')}}">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url{{asset('asset/images/bg_2.jpg')}};">
