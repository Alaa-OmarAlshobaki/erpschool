                ...
                <header>
                    <div class="header-w3layouts">
                        <h1>
                            <a class="navbar-brand logo" href="index.html">
                              <img src="public/onepage/img/logo_18.png">   @lang('dashboard.dashboard.ERPSchool')
                            </a>
                        </h1>
                    </div>
                    <div class="nav_w3pvt">
                    ...
                    <div class="buttons mt-lg-0 mt-3 ml-auto">
                        <div class="form-w3layouts-grid">
							@isset($url)
							<form method="POST"  class="newsletter" action='{{ url("login/$url") }}' aria-label="{{ __('Login') }}">
							@else
							<form method="POST"  class="newsletter" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
							@endisset
								@csrf
