...
<html lang="en">
  ...
  <body>
	  <div class="py-2 bg-primary">
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
                ...
                @foreach($dataOfInstitution as $infInstitution)
              <span class="text">{{$infInstitution->Institution_Address}}</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-secondary mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
              <span class="text">{{$infInstitution->Institution_Email}}</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-tertiary mr-2 d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
              <span class="text">{{$infInstitution->Institution_Phone}}</span>
                @endforeach
					    </div>
				    </div>
			    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
      ...
      <a class="navbar-brand" href="{{route('Home')}}">@lang('dashboard.dashboard.ERPSchool')</a>
				<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="oi oi-menu"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="{{route('Home')}}" class="nav-link pl-0">@lang('dashboard.dashboard.Home')</a></li>
	        	<li class="nav-item"><a href="#login" class="nav-link">@lang('dashboard.dashboard.login')</a></li>
	        	<li class="nav-item"><a href="#teacher" class="nav-link">@lang('dashboard.dashboard.OurTeacher')</a></li>
	        	<li class="nav-item"><a href="#courses" class="nav-link">@lang('dashboard.dashboard.Courses')</a></li>
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-8 text-center ftco-animate">
            ...
            <p id="login"><a href="#" class="btn btn-secondary px-4 py-3 mt-3">Read More</a></p>
          </div>
        </div>
        </div>
      </div>
    ...
    <section  class="ftco-services ftco-no-pb">
          ...
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">@lang('dashboard.dashboard.Login_As_admin')</h3>
          ...
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-tertiary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">@lang('dashboard.dashboard.Login_As_Student')</h3>
                {{-- <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p> --}}
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-fifth">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">@lang('dashboard.dashboard.Login_As_employee')</h3>
                {{-- <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p> --}}
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-quarternary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">@lang('dashboard.dashboard.Login_As_Guardian')</h3>
                {{-- <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p> --}}
              </div>
            </div>      
          </div>
		...
		<section class="ftco-section ftco-no-pb">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>OUR</span> Teachers</h2>
            {{-- <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p> --}}
          </div>
        </div>	
				<div class="row">
          @foreach($dataEmployee as $dataOfTeacher)
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
                {{-- <div class="img align-self-stretch" style="background-image: url(images/teacher-1.jpg);"></div> --}}
              <div class="img align-self-stretch"><img src={{$dataOfTeacher->avatar}}></div>
			    	</div>
							<div class="text pt-3 text-center">
              <h3>{{$dataOfTeacher->firstName . " " .$dataOfTeacher->middleName . " ".$dataOfTeacher->lastName}}</h3>
								<span class="position mb-2">Teacher</span>
								<div class="faded">
                  <p>{{$dataOFTeacher->employee_ID_number}}</p>
                  <p>{{$dataOFTeacher->Phone}}</p>
                  <p>{{$dataOFTeacher->email}}</p>
		...
		<section class="ftco-section">
			<div class="container">
				<div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>@lang('dashboard.dasboard.Our')</span>@lang('dashboard.dashboard.Courses') </h2>
            {{-- <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p> --}}
          </div>
        </div>	
				<div class="row">
          @foreach($dataOfCourse as $course)
